-- =============================================================================
-- SIMPLE FIX: Replace get_bracket_data with simple working version
-- =============================================================================

-- Drop and recreate with a simple, working implementation
...
-- Add comment
COMMENT ON FUNCTION public.get_bracket_data(UUID) IS 'Simple get bracket data function without complex joins to avoid GROUP BY issues';