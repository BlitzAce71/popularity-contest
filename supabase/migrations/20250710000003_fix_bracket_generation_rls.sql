-- Fix bracket generation function to work with RLS policies after tournament reset
-- Add SECURITY DEFINER to allow system operations and fix contestant seeding
