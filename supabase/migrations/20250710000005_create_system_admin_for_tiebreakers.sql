...
-- First, revert the previous constraint change back to the original
...
-- Create a system admin user for tie-breaker votes
-- This user will be used for all administrative tie-breaking decisions
INSERT INTO auth.users (
    ...
    'aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee', -- Fixed UUID for system admin
    'authenticated',
    'authenticated', 
...
COMMENT ON TABLE public.users IS 'Users table with special system admin user for tie-breaker votes';