-- Regional Tournament Seeding: Treat each region as separate tournament
-- Each region uses proper tournament seeding (1 vs highest, 2 vs second highest, etc.)
-- Regional winners advance to Final Four: A vs C, B vs D
...
BEGIN
    ...
    VALUES (
        ...
        END,
        'active',
        total_contestants / 2,  -- Total first round matchups across all regions
        0
    );
